/* LOCAL PREVIEW ONLY — register the now-* components so the playground renders the bar,
 * button, and modal. These imports are NOT in the deployed bundle: `snc ui-component
...
import '../src/x-gegis-library-selected-product';
